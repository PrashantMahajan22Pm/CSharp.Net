...
class Singly
{
    ...
    public void Display()
    {
       Console.WriteLine("Element of LinkedList is ");
     Node temp = first;

     while(temp != null)
     {
      Console.WriteLine("Name is "+temp.Name+" It data Enrey is "+temp.data);
      temp= temp.next; 
    }
...
class SinglyLinkList {
    ...
    Console.WriteLine("Number of elements are : "+obj.Count()); 
